                    ...
                    <div class="container-fluid m-0 p-0">
                        <div class="row m-0 p-0">
                            ...
                            <div class="col-md-4 p-2">
                                ...
                                <input readonly id="mobile" placeholder="Mobile" class="form-control" type="mobile"/>
                            </div>
                        </div>
                        <div class="row m-0 p-0">
                            <div class="col-md-4 p-2">
                                <button onclick="onUpdate()" class="btn mt-3 w-100  btn btn-primary">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    async function onUpdate() {
        ...
        if(firstName.length===0){
            ...
            // showLoader();
            let res=await axios.post("/api/CreateProfile",{
                firstName:firstName,
                lastName:lastName,
            })
            // hideLoader();
